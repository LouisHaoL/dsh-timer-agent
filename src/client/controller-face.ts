...
export interface BoardControllerFace {
  ...
  updateJob(id: string, patch: Partial<Pick<JobRecord, 'title' | 'description' | 'prompt'>> & { target?: SessionTarget; cron?: string; scheduleEnabled?: boolean; webhookEnabled?: boolean }): Promise<void> | void
